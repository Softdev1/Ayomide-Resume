      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
          ...
          <div className="grid lg:grid-cols-5 gap-12 sm:gap-16 w-full">
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                <div className="text-sm text-muted-foreground font-mono tracking-wider">PRODUCT PORTFOLIO</div>
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Akindutire
                  <br />
                  <span className="text-muted-foreground">Ayomide</span>
                </h1>
              </div>

              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Senior Software Engineer | 10+ Years of Experience crafting digital experiences at the intersection of
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
                  <button className="group px-6 py-3 bg-foreground text-background rounded-lg hover:bg-muted-foreground transition-all duration-300 flex items-center justify-center gap-2 text-sm font-medium">
                    <svg
                  ...
                  <button className="group px-6 py-3 border border-border rounded-lg hover:border-muted-foreground/50 hover:bg-muted/20 transition-all duration-300 flex items-center justify-center gap-2 text-sm font-medium">
                    <svg
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V6a2 2 0 012-2h4a2 2 0 012 2v1m-6 0h6m-6 0l-1 1v8a2 2 0 002 2h4a2 2 0 002-2V8l-1-1"
                      />
                    </svg>
                    Book Session
                  </button>
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-muted-foreground">Canadian Wealth Inc. | Calgary, Alberta, Canada</div>
                  <div className="text-xs text-muted-foreground">SEPTEMBER 2020 - AUGUST 2022</div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Design Patterns", "Php", "Server Administration", "Nodejs", "Typescript", "Java","Sprintboot", "Laravel"].map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 text-xs border border-border rounded-full hover:border-muted-foregrounds/50 transition-colors duration-300"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">© 2025 Akindutire Ayomide. All rights reserved.</div>
              <div className="text-xs text-muted-foreground">Built with by Akindutire Ayomide</div>
            </div>
